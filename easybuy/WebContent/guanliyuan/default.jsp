...
{
  window.open('guanliyuan/goodswind.jsp?id='+id+'&name='+name,'infoWin', 'height=400,width=600,scrollbars=yes,resizable=yes');
}
    </Script>
...
<div class="nav">
        <ul>
            <li><a href="guanliyuan/goodsedit.jsp" >商品管理</a></li>
            <li><a href="guanliyuan/userselect.jsp" >用户管理</a></li>
...
<br>
    ...
    <table align=center width="350">
       ...
       <tr>
          ...
          <td><p align=center><a href="user/fengleiResult.jsp?key=箱包"><strong>箱包</strong></a></p></td>
...
<p align=center><a href="guanliyuan/goodsedit.jsp">编辑商品</a></p>
<br><br>
